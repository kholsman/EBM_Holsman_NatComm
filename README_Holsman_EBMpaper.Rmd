  ...
  #-------------------------------------      
    ...
    if(readdat==FALSE){
      ...
      if(!any(dir()%in%"EBM_ceattlenew.Rdata"))
        stop("EBM_ceattlenew.Rdata file not found, please go to https://figshare.com/s/6dea7722df39e07d79f0 and download file into EBM_Holsman_NatComm/EBM_ceattlenew.Rdata")}
