...
## Input data:
Raw input files can be found under the **data** folder and **assessment_scripts/CEATTLE/src/Data** folders. 

## Intermediate data:
Intermediate data can be found in the main EBM_Holsman_NatComm in the form of .Rdata files.
...
```{r EBM_paper, eval=FALSE, echo=FALSE}
...
# 3.  make figures
  ...
  #-------------------------------------  
    ...
    main  <-  path.expand("~/Documents/D_AFSC_Files/Manuscripts/00_EBM_ACLIM_CEATTLE/EBM_Holsman_NatComm")
    setwd(main)
