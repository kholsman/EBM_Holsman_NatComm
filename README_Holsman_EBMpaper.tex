...
\subsubsection{1.1. Data and Figures}\label{data-and-figures}
...
\subsubsection{2.1. Download the code from the github
...
\subsubsection{2.2. Download data from
...
\subsubsection{3.1. Set things up:}\label{set-things-up}
...
\subsubsection{3.2. Regenerate plots:}\label{regenerate-plots}
...
\subsubsection{3.3. Regenerate analyses and final
...
\subsubsection{4.1. Bering10K ROMSNPZ}\label{bering10k-romsnpz}
...
\subsubsection{4.2. CEATTLE}\label{ceattle}
...
\subsubsection{4.3. ATTACH}\label{attach}
