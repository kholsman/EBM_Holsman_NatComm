...
void model_parameters::initializationfunction(void)
{
  ...
  sel_a50_bts.set_initial_value(4.5);
...
dvariable model_parameters::get_SER(_CONST dvariable& Ftmp)
{
  ofstream& srecout= *pad_srecout;
  ofstream& projout= *pad_projout;
  ofstream& nofish= *pad_nofish;
...
dvariable model_parameters::get_SER(dvar_vector& Ntmp, _CONST dvariable& Ftmp)
{
  ofstream& srecout= *pad_srecout;
  ofstream& projout= *pad_projout;
  ofstream& nofish= *pad_nofish;
...
dvariable model_parameters::SRecruit(_CONST dvariable& Stmp)
{
  ofstream& srecout= *pad_srecout;
  ofstream& projout= *pad_projout;
  ofstream& nofish= *pad_nofish;
...
dvar_vector model_parameters::SRecruit(_CONST dvar_vector& Stmp)
{
  ofstream& srecout= *pad_srecout;
  ofstream& projout= *pad_projout;
  ofstream& nofish= *pad_nofish;
...
dvariable model_parameters::Requil(_CONST dvariable& phi)
{
  ofstream& srecout= *pad_srecout;
  ofstream& projout= *pad_projout;
  ofstream& nofish= *pad_nofish;
...
dvariable model_parameters::robust_p(dmatrix& obs,dvar_matrix& pred,_CONST dvariable& a, _CONST data_ivector& b, _CONST int amin, _CONST int amax)
{
  ofstream& srecout= *pad_srecout;
  ofstream& projout= *pad_projout;
  ofstream& nofish= *pad_nofish;
...
dvariable model_parameters::robust_p(_CONST dmatrix& obs,_CONST dvar_matrix& pred,_CONST dvariable& a, _CONST data_ivector& b)
{
  ofstream& srecout= *pad_srecout;
  ofstream& projout= *pad_projout;
  ofstream& nofish= *pad_nofish;
...
dvariable model_parameters::robust_p(_CONST dmatrix& obs, _CONST dvar_matrix& pred, _CONST dvariable& a, _CONST dvariable& b)
{
  ofstream& srecout= *pad_srecout;
  ofstream& projout= *pad_projout;
  ofstream& nofish= *pad_nofish;
...
dvariable model_parameters::robust_p(_CONST dvector& obs, _CONST dvar_vector& pred, _CONST dvariable& a, _CONST dvariable& b)
{
  ofstream& srecout= *pad_srecout;
  ofstream& projout= *pad_projout;
  ofstream& nofish= *pad_nofish;
...
dvar_matrix model_parameters::compute_selectivity(int stsel,_CONST dvariable& slp,_CONST dvariable& a50)
{
  ofstream& srecout= *pad_srecout;
  ofstream& projout= *pad_projout;
  ofstream& nofish= *pad_nofish;
...
dvar_matrix model_parameters::compute_selectivity(int stsel,_CONST dvariable& slp,_CONST dvariable& a50,_CONST dvar_vector& a50_dev)
{
  ofstream& srecout= *pad_srecout;
  ofstream& projout= *pad_projout;
  ofstream& nofish= *pad_nofish;
...
dvar_matrix model_parameters::compute_selectivity(int stsel,_CONST dvariable& slp,_CONST dvariable& a50,_CONST dvar_vector& se,_CONST dvar_vector& ae)
{
  ofstream& srecout= *pad_srecout;
  ofstream& projout= *pad_projout;
  ofstream& nofish= *pad_nofish;
...
dvar_matrix model_parameters::compute_selectivity(int stsel,_CONST dvar_vector& slp,_CONST dvar_vector& a50)
{
  ofstream& srecout= *pad_srecout;
  ofstream& projout= *pad_projout;
  ofstream& nofish= *pad_nofish;
...
dvar_matrix model_parameters::compute_selectivity1(int stsel,_CONST dvariable& dif,_CONST dvariable& a50,_CONST dvariable& trm)
{
  ofstream& srecout= *pad_srecout;
  ofstream& projout= *pad_projout;
  ofstream& nofish= *pad_nofish;
...
dvar_matrix model_parameters::compute_selectivity1(int stsel,_CONST dvariable& dif,_CONST dvariable& a50,_CONST dvariable& trm,_CONST dvar_matrix& devs)
{
  ofstream& srecout= *pad_srecout;
  ofstream& projout= *pad_projout;
  ofstream& nofish= *pad_nofish;
...
dvar_matrix model_parameters::compute_selectivity2(int stsel,_CONST dvar_vector& slp,_CONST dvar_vector& a50,_CONST dvar_matrix& devs)
{
  ofstream& srecout= *pad_srecout;
  ofstream& projout= *pad_projout;
  ofstream& nofish= *pad_nofish;
...
dvar_matrix model_parameters::compute_selectivity3(int stsel,_CONST dvar_vector& dif,_CONST dvar_vector& a50)
{
  ofstream& srecout= *pad_srecout;
  ofstream& projout= *pad_projout;
  ofstream& nofish= *pad_nofish;
...
dvar_matrix model_parameters::compute_selectivity3(int stsel,_CONST dvar_vector& dif,_CONST dvar_vector& a50,_CONST dvar_matrix& devs)
{
  ofstream& srecout= *pad_srecout;
  ofstream& projout= *pad_projout;
  ofstream& nofish= *pad_nofish;
...
dvar_matrix model_parameters::compute_selectivity(int stsel,_CONST dvar_vector& slp,_CONST dvar_vector& a50,_CONST dvar_matrix& devs)
{
  ofstream& srecout= *pad_srecout;
  ofstream& projout= *pad_projout;
  ofstream& nofish= *pad_nofish;
...
dvar_matrix model_parameters::compute_fsh_selectivity(int nsel,int stsel,dvariable& avgsel,_CONST dvar_vector& coffs,_CONST dvar_matrix& sel_devs,int  gn)
{
  ofstream& srecout= *pad_srecout;
  ofstream& projout= *pad_projout;
  ofstream& nofish= *pad_nofish;
...
dvar_matrix model_parameters::compute_selectivity_eit(int nsel,int stsel,dvariable& avgsel,_CONST dvar_vector& coffs)
{
  ofstream& srecout= *pad_srecout;
  ofstream& projout= *pad_projout;
  ofstream& nofish= *pad_nofish;
...
dvar_matrix model_parameters::compute_selectivity_eit(int nsel,int stsel,dvariable& avgsel,_CONST dvar_vector& coffs,_CONST dvar_matrix& sel_devs)
{
  ofstream& srecout= *pad_srecout;
  ofstream& projout= *pad_projout;
  ofstream& nofish= *pad_nofish;
...
dvar_matrix model_parameters::compute_selectivity(int nsel,int stsel,dvariable& avgsel,_CONST dvar_vector& coffs,_CONST dvar_matrix& sel_devs,int  gn)
{
  ofstream& srecout= *pad_srecout;
  ofstream& projout= *pad_projout;
  ofstream& nofish= *pad_nofish;
...
dvar_matrix model_parameters::compute_selectivity(int nsel,int stsel,dvariable& avgsel,_CONST dvar_vector& coffs)
{
  ofstream& srecout= *pad_srecout;
  ofstream& projout= *pad_projout;
  ofstream& nofish= *pad_nofish;
...
dvariable model_parameters::SolveF2(_CONST dvar_vector& N_tmp, double  TACin)
{
  ofstream& srecout= *pad_srecout;
  ofstream& projout= *pad_projout;
  ofstream& nofish= *pad_nofish;
...
double model_parameters::mn_age(_CONST dvar_vector& pobs)
{
  ofstream& srecout= *pad_srecout;
  ofstream& projout= *pad_projout;
  ofstream& nofish= *pad_nofish;
...
double model_parameters::Sd_age(_CONST dvar_vector& pobs, _CONST dvar_vector& phat)
{
  ofstream& srecout= *pad_srecout;
  ofstream& projout= *pad_projout;
  ofstream& nofish= *pad_nofish;
...
double model_parameters::Eff_N_adj(_CONST double, _CONST dvar_vector& pobs, _CONST dvar_vector& phat)
{
  ofstream& srecout= *pad_srecout;
  ofstream& projout= *pad_projout;
  ofstream& nofish= *pad_nofish;
...
double model_parameters::Eff_N2(_CONST dvar_vector& pobs, _CONST dvar_vector& phat)
{
  ofstream& srecout= *pad_srecout;
  ofstream& projout= *pad_projout;
  ofstream& nofish= *pad_nofish;
...
double model_parameters::Eff_N(_CONST dvar_vector& pobs, _CONST dvar_vector& phat)
{
  ofstream& srecout= *pad_srecout;
  ofstream& projout= *pad_projout;
  ofstream& nofish= *pad_nofish;
