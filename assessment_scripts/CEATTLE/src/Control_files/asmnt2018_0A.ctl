...
ceattle
#datafile_name
dat_input_files/01_assessment_2018/2018_asmt_corrected0.dat
#dietfile_name
#dat_input_files/diet.dat
#diet2file_name 
dat_input_files/01_assessment_2018/diet2.dat
#stomfile_name 
dat_input_files/01_assessment_2018/stomach2018.dat
#Fprofile_datafile
dat_input_files/01_assessment_2018/F_profile.dat
#ATFfile_name 
dat_input_files/01_assessment_2018/ATF_Misc.dat
#Recfile_name    #fits_4_CEATTLE/rs_data4CEATTLE_fallZtot.dat
fits_4_CEATTLE/rs_data4CEATTLE_full_avg.dat
#retrofile_name
dat_input_files/01_assessment_2018/retro_data2018_asssmnt_ALLCOV.dat
#futfile_name
dat_input_files/01_assessment_2018/proj_data2018_long_ext_bcs_ALLCOV.dat
#catch_in_name
dat_input_files/01_assessment_2018/catch_in.dat
#setC_name 
dat_input_files/01_assessment_2018/set_catch.dat
#setF_name 
dat_input_files/01_assessment_2018/setF40_datfiles/F40In_2_1_9.dat
...
1 7 #Individual stocks  fished  to  B40%; pcod, then plk,  then  atf
#1 1 #Individual stocks  fished  to  B40% where B0 is set to the B0 from no climate (using B0 set in .ctl file)                                    
...
0.4
#B0_set: ADDED target  spawning  biomass for control rules (ie 0.35  such  that  B/B0  =.35)# multispp B0 based on CR 1.1 
